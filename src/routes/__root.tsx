...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Rainbow Sports — Premium Sports Jerseys" },
